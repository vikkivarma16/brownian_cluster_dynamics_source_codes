...
echo "1" >> Base_data.txt  #particle type id inserted as widom particle, remember the type id 0 is reserved for the obstacles and the particle type id assignment starts from 1 
...
gcc  bcd_hard_spheroids_obstacle_widoms.c -o  bcd_hard_spheroids_obstacle_widoms -lm
./bcd_hard_spheroids_obstacle_widoms
